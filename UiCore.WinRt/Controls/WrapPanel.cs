...
namespace Mt.Common.UiCore.Controls
{
	...
	public class WrapPanel : Panel
	{
		...
		/// contained in a <see cref="T:Mt.Common.UiCore.Controls.WrapPanel" />.
		/// </summary>
		/// <value>
		/// The height applied to the layout area of each item that is contained
		/// within a <see cref="T:Mt.Common.UiCore.Controls.WrapPanel" />.  The
		...
		/// <summary>
		/// Identifies the
		/// <see cref="P:Mt.Common.UiCore.Controls.WrapPanel.ItemHeight" />
		/// dependency property.
		/// </summary>
		/// <value>
		...
		/// <summary>
		/// Identifies the
		/// <see cref="P:Mt.Common.UiCore.Controls.WrapPanel.ItemWidth" />
		/// dependency property.
		/// </summary>
		/// <value>
		/// The identifier for the
		...
		/// <summary>
		/// Identifies the
		/// <see cref="P:Mt.Common.UiCore.Controls.WrapPanel.Orientation" />
		/// dependency property.
		/// </summary>
		/// <value>
		/// The identifier for the
		...
		/// <see cref="T:Mt.Common.UiCore.Controls.WrapPanel" /> class.
		/// </summary>
		public WrapPanel()
		{
		}
		...
		/// <see cref="T:Mt.Common.UiCore.Controls.WrapPanel" /> in anticipation
		...
		/// <see cref="T:Mt.Common.UiCore.Controls.WrapPanel" /> and its 
		/// elements.
		/// </returns>
		...
		/// <see cref="T:Mt.Common.UiCore.Controls.WrapPanel" /> control and its
		/// child elements.
		/// </summary>
		/// <param name="finalSize">
		/// The area within the parent that the
		/// <see cref="T:Mt.Common.UiCore.Controls.WrapPanel" /> should use 
		/// arrange itself and its children.
		/// </param>
		/// <returns>
		/// The actual size used by the
		/// <see cref="T:Mt.Common.UiCore.Controls.WrapPanel" />.
		/// </returns>
