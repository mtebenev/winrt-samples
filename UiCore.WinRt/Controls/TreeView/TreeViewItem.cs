...
namespace Mt.Common.UiCore.Controls.TreeView
{
	/// <summary>
	...
	public partial class TreeViewItem : HeaderedItemsControl, IUpdateVisualState
	{
		...
		/// <see cref="T:Mt.Common.UiCore.Controls.TreeView.TreeViewItem" /> contains
		/// items.
		/// </summary>
		/// <value>
		/// True if this <see cref="T:Mt.Common.UiCore.Controls.TreeView.TreeViewItem" />
		...
		/// <summary>
		/// Identifies the
		/// <see cref="P:Mt.Common.UiCore.Controls.TreeView.TreeViewItem.HasItems" />
		/// dependency property.
		/// </summary>
		/// <value>
		...
		/// <summary>
		/// Identifies the
		/// <see cref="P:Mt.Common.UiCore.Controls.TreeView.TreeViewItem.IsExpanded" />
		/// dependency property.
		/// </summary>
		/// <value>
		/// The identifier for the
		...
		private static void OnIsExpandedPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
		{
			...
			if(isExpanded)
			{
				...
				if(source.ExpansionStateGroup == null && source.UserInitiatedExpansion)
				{
					...
					UiCore.Controls.TreeView.TreeView parent = source.ParentTreeView;
					if(parent != null)
					{
		...
		/// <see cref="T:Mt.Common.UiCore.Controls.TreeView.TreeViewItem" /> is selected.
		/// </summary>
		/// <value>
		/// True if this <see cref="T:Mt.Common.UiCore.Controls.TreeView.TreeViewItem" />
		...
		/// <summary>
		/// Identifies the
		/// <see cref="P:Mt.Common.UiCore.Controls.TreeView.TreeViewItem.IsSelected" />
		/// dependency property.
		/// </summary>
		/// <value>
		/// The identifier for the
		...
		/// <see cref="T:Mt.Common.UiCore.Controls.TreeView.TreeViewItem" /> has focus.
		/// </summary>
		/// <value>
		/// True if this <see cref="T:Mt.Common.UiCore.Controls.TreeView.TreeViewItem" />
		...
		/// <summary>
		/// Identifies the
		/// <see cref="P:Mt.Common.UiCore.Controls.TreeView.TreeViewItem.IsSelectionActive" />
		/// dependency property.
		/// </summary>
		/// <value>
		/// The identifier for the
		...
		internal ItemsControl ParentItemsControl
		{
			...
			set
			{
				...
				UiCore.Controls.TreeView.TreeView parentTreeView = ParentTreeView;
		...
		/// </summary>
		internal UiCore.Controls.TreeView.TreeView ParentTreeView
		{
			get
			{
				...
				while(current != null)
				{
					UiCore.Controls.TreeView.TreeView view = current.ParentItemsControl as UiCore.Controls.TreeView.TreeView;
					if(view != null)
					{
						return view;
					}
		...
		private bool IsRoot
		{
			get { return ParentItemsControl is UiCore.Controls.TreeView.TreeView; }
		}
		...
		/// Occurs when the
		/// <see cref="P:Mt.Common.UiCore.Controls.TreeView.TreeViewItem.IsSelected" />
		/// property of a <see cref="T:Mt.Common.UiCore.Controls.TreeView.TreeViewItem" />
		...
		/// <see cref="T:Mt.Common.UiCore.Controls.TreeView.TreeViewItem" /> class.
		/// </summary>
		public TreeViewItem()
		{
		...
		/// <see cref="T:System.Windows.Automation.Peers.TreeViewItemAutomationPeer" />
		/// object for the
		/// <see cref="T:Mt.Common.WinRtUiCore.Controls.TreeView.TreeViewItem" />.
		/// </returns>
		...
		/// <see cref="T:Mt.Common.UiCore.Controls.TreeView.TreeViewItem" /> control when a
		...
		private void BringIntoView()
		{
			...
			if(UserInitiatedExpansion)
			{
				...
				UiCore.Controls.TreeView.TreeView parent = ParentTreeView;
...
#pragma warning restore 4014
		...
		#region ItemsControl
		/// <summary>
		/// Creates a <see cref="T:Mt.Common.UiCore.Controls.TreeView.TreeViewItem" /> to
		/// display content.
		/// </summary>
		/// <returns>
		/// A <see cref="T:Mt.Common.UiCore.Controls.TreeView.TreeViewItem" /> to use as a
		...
		/// <see cref="T:Mt.Common.UiCore.Controls.TreeView.TreeViewItem" />.
		/// </summary>
		/// <param name="item">The object to evaluate.</param>
		/// <returns>
		/// True if <paramref name="item" /> is a
		/// <see cref="T:Mt.Common.UiCore.Controls.TreeView.TreeViewItem" />; otherwise,
		/// false.
		/// </returns>
		...
		protected override void PrepareContainerForItemOverride(DependencyObject element, object item)
		{
			...
			if(node != null)
			{
				...
				var isSelectedBindingPath = UiCore.Controls.TreeView.TreeView.GetIsSelectedBindingPath(this) ?? UiCore.Controls.TreeView.TreeView.GetIsSelectedBindingPath(node);
				var isExpandedBindingPath = UiCore.Controls.TreeView.TreeView.GetIsExpandedBindingPath(this) ?? UiCore.Controls.TreeView.TreeView.GetIsExpandedBindingPath(node);

				if(isSelectedBindingPath != null)
				{
					if(node.ReadLocalValue(UiCore.Controls.TreeView.TreeView.IsSelectedBindingPathProperty) == DependencyProperty.UnsetValue)
					{
						UiCore.Controls.TreeView.TreeView.SetIsSelectedBindingPath(node, isSelectedBindingPath);
					}
				...
				{
					if(node.ReadLocalValue(UiCore.Controls.TreeView.TreeView.IsExpandedBindingPathProperty) == DependencyProperty.UnsetValue)
					{
						UiCore.Controls.TreeView.TreeView.SetIsExpandedBindingPath(node, isExpandedBindingPath);
					}
		...
		/// as a <see cref="T:Mt.Common.UiCore.Controls.TreeView.TreeViewItem" />.
		/// </summary>
		/// <param name="element">
		/// The <see cref="T:Mt.Common.UiCore.Controls.TreeView.TreeViewItem" /> element to
		/// clear.
		/// </param>
		/// <param name="item">
		...
		protected override void OnItemsChanged(object e)
		{
			...
			UiCore.Controls.TreeView.TreeView parentTreeView = null;
			//switch (e.Action)
			switch(true)
			{
		...
		protected override void OnPointerPressed(PointerRoutedEventArgs e)
		{
			...
			UiCore.Controls.TreeView.TreeView parent;
			...
			if(Interaction.AllowKeyDown(e))
			{
				...
				switch(invariantKey)
				{
					case VirtualKey.Left:
						...
						// collapsed.
						if(!UiCore.Controls.TreeView.TreeView.IsControlKeyDown && CanExpandOnInput && IsExpanded)
						{
					...
					case VirtualKey.Right:
						...
						// children
						if(!UiCore.Controls.TreeView.TreeView.IsControlKeyDown && CanExpandOnInput)
						{
						...
						break;
					case VirtualKey.Up:
						if(!UiCore.Controls.TreeView.TreeView.IsControlKeyDown && HandleUpKey())
						{
							e.Handled = true;
						}
						break;
					case VirtualKey.Down:
						if(!UiCore.Controls.TreeView.TreeView.IsControlKeyDown && HandleDownKey())
						{
							e.Handled = true;
						}
						break;
		...
		private void Select(bool selected)
		{
			...
			UiCore.Controls.TreeView.TreeView view = ParentTreeView;
