...
namespace Mt.Common.UiCore.Controls.TreeView
{
	...
	public partial class TreeView : ItemsControl, IUpdateVisualState
	{
		...
		/// <see cref="T:Mt.Common.UiCore.Controls.TreeView.TreeView" />.
		/// </summary>
		/// <value>
		...
		/// <summary>
		/// Identifies the
		/// <see cref="P:Mt.Common.UiCore.Controls.TreeView.TreeView.SelectedItem" />
		/// dependency property.
		/// </summary>
		/// <value>
		...
		/// <see cref="P:Mt.Common.UiCore.Controls.TreeView.TreeView.SelectedValuePath" />
		/// property.
		/// </summary>
		/// <value>
		/// The value of the
		...
		/// <summary>
		/// Identifies the
		/// <see cref="P:Mt.Common.UiCore.Controls.TreeView.TreeView.SelectedValue" />
		/// dependency property.
		/// </summary>
		/// <value>
		/// The identifier for the
		...
		/// property of the
		/// <see cref="P:Mt.Common.UiCore.Controls.TreeView.TreeView.SelectedItem" />
		/// property in a <see cref="T:Mt.Common.UiCore.Controls.TreeView.TreeView" />.
		/// </summary>
		/// <value>
		...
		/// property of the
		/// <see cref="P:Mt.Common.UiCore.Controls.TreeView.TreeView.SelectedItem" />
		/// property in a <see cref="T:Mt.Common.UiCore.Controls.TreeView.TreeView" />. The
		...
		/// <see cref="T:Mt.Common.UiCore.Controls.TreeView.TreeView" /> class.
		/// </summary>
		public TreeView()
		{
		...
		/// A
		/// <see cref="T:System.Windows.Automation.Peers.TreeViewAutomationPeer" />
		/// for the <see cref="T:Mt.Common.UiCore.Controls.TreeView.TreeView" /> control.
		/// </returns>
		...
		/// <see cref="T:Mt.Common.UiCore.Controls.TreeView.TreeView" /> control when a new
		...
		/// <see cref="T:Mt.Common.WinRtUiCore.Controls.TreeView.TreeView" /> control.
		/// </summary>
