...
namespace Mt.Common.WinRtAppCore.Platform
{
	/// <summary>
	/// Provides functionality to .NET CultureInfo.GetCultures
	/// TODO: it should be verified: most probably this code is not actually portable
	/// </summary>
